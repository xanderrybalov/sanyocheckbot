...
function getHTML(req, res) {
    ...
    res.write('<h1>Greetings from my HTTP server!</h1>');
    ...
    if (req.headers['content-type'] === 'application/x-www-form-urlencoded') {
        ...
        req.on('end', () => {
            try {
                ...
                res.statusCode = 200;
                res.setHeader('Content-Type', 'text/html');
                res.write('<h1>Command data was received</h1>');
        ...
        req.on('end', () => {
            try {
                ...
                res.statusCode = 200;
                res.end('Command data was received');
            } catch (error) {
                res.statusCode = 400;
...
function handleNotFound(req, res) {
    res.statusCode = 404;
    res.setHeader('Content-Type', 'text/html');
    res.end('SORRY THIS PAGE IS NOT FOUND! KEKEKEKE');
}
